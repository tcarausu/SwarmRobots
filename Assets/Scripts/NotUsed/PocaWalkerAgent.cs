...
public class PocaWalkerAgent : Agent
{
    ...
    public float rewardTargetProximity = 0.0f;
    ...
    private List<PocaWalkerAgent> otherAgents;
    ...
    private SwarmEnvController envController;
    ...
    private void ReachedTarget()
    {
        ...
        //EndEpisode();
        //foreach (PocaWalkerAgent agent in otherAgents)
        //{
    ...
    private void CheckNearTarget()
    {
        ...
        if (Physics.Raycast(transform.position, dir, out RaycastHit hit))
        {
            ...
            {
                AddReward((1 / hit.distance) * rewardTargetProximity);
            }
        }
    }
